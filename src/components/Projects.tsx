    ...
    <>
      <section className={styles.projetos}>
        ...
        <div className={styles["texto-projetos"]}>
          <h1 style={{"--i": 0} as React.CSSProperties}>&#x1F9F0; Projetos</h1>
          ...
          <p style={{"--i": 4} as React.CSSProperties}>
            ...
            que você vê por aqui. Essa experiência me levou a estudar mais sobre
            infraestrutura e DevOps, obtendo certificações do{" "}
            <a
              target="_blank"
